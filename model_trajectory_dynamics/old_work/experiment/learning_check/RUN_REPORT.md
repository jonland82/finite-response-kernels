...
The closed condition's observable information lower bound moved from -0.840 to 8.782 bits out of a 16-bit source. Its final checkpoint increment proxy was 7.949 bits.

The open control ended at 11.389 recoverable bits after the available source expanded to 22 bits.
...
|---|---:|---:|---:|---:|
| closed | 16 | 8.782 | 0.738 | 0.0306 |
| open | 22 | 11.389 | 0.832 | 0.0318 |
...
```json
{
  ...
  "config": {
    ...
    "maximum_facts": 32,
    "output_dir": "model_trajectory_dynamics/experiment/learning_check",
    "replicas": 8,
    "reveal_interval": 20,
    "seed": 20260720,
    "skip_influence": true,
